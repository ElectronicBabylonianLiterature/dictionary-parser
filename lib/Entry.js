...
const parseNestedMeanings = require('./parseNestedMeanings')
...
module.exports = class Entry {
  ...
  get nestedMeanings () {
    const rawNestedMeanings = this.match[nestedMeaningsIndex]
    return parseNestedMeanings(rawNestedMeanings || '')
  }
