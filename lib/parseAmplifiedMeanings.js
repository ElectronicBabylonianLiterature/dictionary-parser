...
class Accumulator {
  ...
  startTopLevel (topLevelKey) {
    ...
    this.result[topLevelKey] = Accumulator.createTopLevelEntry()
  }
  ...
  startEntry (entryKey) {
    ...
    this.entryIndex = this.result[this.topLevelKey].entries.length
    this.result[this.topLevelKey].entries[this.entryIndex] = Accumulator.createEntry()
  }

  addMeaning (meaning) {
    const entry = _.isNil(this.entryIndex) ? this.result[this.topLevelKey] : this.result[this.topLevelKey].entries[this.entryIndex]
